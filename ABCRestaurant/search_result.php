               ...
               <div class="col-md-12">
                 <form action="search_result.php" method="POST">
				   <div class="form-group">
                           <input type="text" id="name"class="email-bt" placeholder="Search Item" name="name" required > <button class="btn btn-search" type="submit" >Search</button>	
                        </div>
			 ...
			 <div class="col-md-12">
				...
				<?php										 
								...
								$name=$_POST['name'];
										...
										$sqlid= "SELECT * FROM food_items WHERE name LIKE '%".$name."%'";	
