					 ...
					 <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="overview-wrap">
                                    ...
                                    <h2 class="title-1">Table Bookings</h2>
...
$sqlid= "SELECT * FROM booking WHERE status='ACCEPTED'";
...
?>
    {
      title: "<?php echo $rowid["name"].' - P '.$rowid["people"].' - B '.$rowid["branch"] ?> ",
      start: moment().format('<?php echo $rowid["date"] ?>'),
      url: '#'
    },
	<?php } ?>
  ];
