	 ...
	 <div  class="col-md-5">
				...
				<table class="table table-bordered" >   
									...
									<tr>  
                                         ...
                                         <td width="70%"><input type="text" name="name" value=""class="form-control"/></td>  
                                       
                                    </tr><tr>  
                                         <td width="30%">Phone</td>  
                                         <td width="70%"><input type="text" name="phone" value=""class="form-control" /></td>  
                                       
                                    </tr><tr>  
                                         <td width="30%">Email</td>  
                                         <td width="70%"><input type="text" name="email" value=""class="form-control"/></td>  
                                       
                                    </tr>

									<tr>  
                                         <td width="30%">Delivery Address</td>  
                                         <td width="70%"><input type="text" name="daddress" value=""class="form-control" /></td>  
								...
								<tr>  
                                         ...
                                         <td width="70%"><input type="text" class="form-control"id="date-time-picker"name="delivery_date" placeholder="Date and Time" autocomplete="off" value="<?php echo date("Y-m-d H:i:s"); ?>"/></td>  
