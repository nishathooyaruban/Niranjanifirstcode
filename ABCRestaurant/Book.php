				  ...
				  <form action="insert_booking.php" method="POST">
                     <div class="email_text">
                        <div class="form-group">
                           <input type="text" class="email-bt" placeholder="Yourname" name="name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
											...
											<input type="text" class="email-bt" id="date-time-picker"name="book_date" placeholder="Date and Time"value="<?php echo date("Y-m-d H:i:s"); ?>" autocomplete="off"/>
											
                        </div>
						
                        <div class="form-group">

                            <input type="text" class="email-bt" placeholder="Number of People" name="people">
                        </div>
                        <div class="form-group">

                           <input type="text" class="email-bt" placeholder="Your phone number" name="phone">
